...
\begin{figure}[p]
  ...
  \centering
    \includegraphics[]{graph--increasing-number-of-files--c1-time-detail}
\end{figure}
...
\begin{figure}[p]
  ...
  \centering
    \includegraphics[]{graph--increasing-number-of-files--prototype-improvements--c1-time-detail}
\end{figure}
...
\begin{figure}[p]
  ...
  \centering
    \includegraphics[]{graph--increasing-number-of-files--c1-cpu-a}
    \includegraphics[]{graph--increasing-number-of-files--c1-cpu-b}
\end{figure}
