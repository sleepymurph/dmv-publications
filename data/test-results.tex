...
\begin{figure}[p]
  ...
  \label{fig:graph--increasing-file-size--c1-time--prototype-improvements}
  \centering
    \includegraphics[]{graph--increasing-file-size--c1-time--detail-high-end--prototype-improvements}
\end{figure}
