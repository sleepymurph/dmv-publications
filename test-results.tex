...
\begin{figure}[p]
  ...
  \label{fig:graph--filesystem-limits--wasted-space}
  \centering
    \includegraphics[]{graph--filesystem-limits--wasted-space}
\end{figure}

Figure \ref{fig:graph--filesystem-limits--wasted-space} shows the mean chunk size.
