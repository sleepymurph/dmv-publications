...
\begin{description}
  ...
  \item[Coverage of data set] How much of the data set is available locally and
    in neighboring nodes?

  \item[Coverage of data history] How much of the data set's history is
    available locally and in neighboring nodes?
...
The goal is to visualize the data in these dimensions for the user, so that they
can make informed decisions about how to access the data they need.
We do not necessarily want to write algorithms for automatic data management,
though we do want it to be possible to build more automated systems as
applications on top of this system.
