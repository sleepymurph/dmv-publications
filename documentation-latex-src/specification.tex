...
Just as version control is a tool for tracking snapshots of a codebase, this
...
\subsubsection{Free-form networks}

Because replicas are autonomous and there is no global state, there is no need
for complicated network membership schemes. Replica network topologies reflect
the connections between their users and their workflow.
