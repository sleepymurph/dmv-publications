...
commit times for Git and DMV increasing exponentially with the number of files,
...
DMV's time increased exponentially, and we suspected that was because it was
