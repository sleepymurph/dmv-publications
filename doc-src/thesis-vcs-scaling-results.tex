...
after five and a half hours.\perotto{Bottleneck was...?}
...
up the repository and aggregates similar objects together in \newterm{pack
files}. The post-garbage collection size for Git is shown as a separate line on
...
\begin{figure}[p]
  ...
  \centering
    ...
    \todo[inline]{overhaul this graph to multiplot like the other times graphs}
\end{figure}
