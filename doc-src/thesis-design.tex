...
\begin{figure}[]
    ...
    \perrolfinline{Again, need consistency to diagrams. Skip the shading, at
    least of the old object types.}
    \todo[inline]{Similar diagram for Git in the intro chapter?}
\end{figure}
