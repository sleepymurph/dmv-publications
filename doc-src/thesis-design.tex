...
The heart\perotto{"Heart" too oral. Try "a central component" or something} of DMV is the directed acyclic graph it uses to store data and
...
Files are split into chunks by content, using a rolling hash
algorithm\perotto{cite}. This
keeps the chunks the same\perotto{clarify} even if content is added or removed from the beginning
...
\todo[inline]{Add diagrams showing different slice types}
