...
\begin{description}
    ...
    \item[Partial history of full data set] Keep a subset of commits, plus all
        ...
        \includegraphics[width=\slicediagramwidth]{dia_dmv_dag_slice_partial_history}
    ...
    \item[Full history of part of data set] Keep all commits, but keep only the
        ...
        \includegraphics[width=\slicediagramwidth]{dia_dmv_dag_slice_history_of_subset}

    \item[Full history of metadata] Keep all commits and trees, but
        omit blobs and chunked blob indexes.

        \includegraphics[width=\slicediagramwidth]{dia_dmv_dag_slice_history_of_metadata}
