...
(\autoref{results-num-files--c1-time}, \autoref{object-dir-layout-results}).
...
number-of-files experiments (\autoref{results-file-size--c1-time},
\autoref{results-num-files--c1-time}).
...
what identifies common byte strings within files.
