...
\begin{figure}
    \caption{Actual output of DMV status command during merge in progress}
    \label{lst_dmv_merge_in_progress}
    \centering
    \lstinputlisting[nolol,basicstyle=\scriptsize]{lst-dmv-merge-in-progress.txt}
\end{figure}

\begin{figure}
    \caption{Actual output of DMV log command}
    \label{lst_dmv_log_output}
    \centering
    \lstinputlisting[nolol,basicstyle=\scriptsize]{lst-dmv-log-output.txt}
\end{figure}
