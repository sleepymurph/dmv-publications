...
\perrolfinline{Yes, definitely include that. Possibly in a description list.}
...
\begin{table}
    ...
    \end{tabular}
    \perrolfinline{This table is the reference point for all other graphs. All
    legends should be consistent with it.}
\end{table}
...
\begin{table}
    ...
    \end{tabular}
    \perrolfinline{Subheaders to name groups instead of horizontal rules?}
\end{table}
