...
normal. \gls{DMV} is dogmatic about the end-to-end
argument~\cite{endtoendargument}, that it cannot anticipate all the needs of end
users and applications. So it aims to be as general and neutral as possible,
focusing on the core task of storage and tracking, and providing a platform for
other applications to build on.
...
\perottoinline{Cost? Performance? Failures? Ease of use? And, when talking about
performance, define your metrics.}
...
files, or only a few branches, or any combination. \todo{Be consistent about
"node" vs "replica"}
