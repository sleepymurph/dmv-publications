...
TODO: DAG provides protection via append-only and crypto-seal

TODO: Missing objects weaken verifiability. Theoretically use hash of missing
object as nonce value that can be manipulated to hopefully find a collision. But
we discount that possibility for now.

TODO: Assume only accept new data from trusted nodes

TODO: Can keep data private by keeping it only on owned nodes on private network
