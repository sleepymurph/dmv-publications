...
$P_n$ denote the rolling hash sum for position $n$ of the input stream. Then a
chunk boundary is where

\begin{equation}
    P_n = \left( \sum_{i = n - w }^{n}{P_i} \right) \bmod d = 0
\end{equation}

In experiments with our implementation of this rolling hash algorithm
