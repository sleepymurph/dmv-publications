...
\perotto{Make sure to include here (or in experiments): version of Linux,
version of Rust, compiler flags used, etc.}
...
We chose Rust because it is a compiled language. Compiling to machine code will
