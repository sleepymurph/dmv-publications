...
We conclude that the version control concept has great potential\perotto{Can
this be said in a more specific way?} for distributed private data storage, and
...
The cryptographic directed acyclic graph is an excellent\perotto{"excellent" too
vague, define and give specific metrics} data structure for long-term data
