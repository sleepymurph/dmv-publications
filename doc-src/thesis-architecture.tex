...
\begin{figure}[h]
  ...
  \perrolfinline{Diagram is inconsistent. Folders make sense, but what are the
  boxes? Nodes?}
\end{figure}
...
\begin{figure}[h]
  ...
  \perrolfinline{Diagram is wildly inconsistent. Should use ovals like every
  other. Varying size is ok, but varying shades look like a b/w printout of a
  color diagram.}
\end{figure}
