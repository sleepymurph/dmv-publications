...
\todo{Traditional ACID}

\todo{Modern NoSQL/BASE}

\todo{New thinking (CAP years later)
   - partitions rare
...
\todo{Explain Git and DAG
    - Append only
    - Easy to sync
    - Trick is merging
}

\todo{Diagram of Git DAG -- remember I have a git history visualizer script}
