...
\cite{as_removed_linux_release_notes}, Linux has included three different I/O
schedulers to choose between\cite{ioschedulers}:
...
\begin{description}
    ...
    \item[Deadline] The \lstinline{deadline} scheduler tries to set hard limits
        on wait time for scheduled I/O operation.
...
The results of the "many files" experiment are shown in
\autoref{fig:plot-iosched-num-files--c1-time}. The I/O scheduler used made
little difference.
