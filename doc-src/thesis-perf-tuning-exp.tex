...
\towrite{Deviation related to divisor}

\towrite{Where window very large, hits a ceiling}

\towrite{My guess, something to do with overflow/underflow, dividing by double,
so large it doesn't matter}
