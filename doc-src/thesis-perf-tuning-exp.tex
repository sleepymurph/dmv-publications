...
of inodes on the filesystem, which on the \SI{100}{\mib} test partition is
\num{25688}. However, the number of directories created increases exponentially
with both the number of hex digits per directory and then again by directory
depth. This can be expressed mathematically.
...
\begin{description}
    ...
    \item[No-op] The \lstinline{noop} scheduler does as little as possible,
        ...
        \perotto{So actually this is a null benchmark}
