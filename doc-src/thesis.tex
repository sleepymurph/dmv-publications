...
\glsresetall
\glsunset{inode}        % inode explained in num-files results
\glsunset{repository}   % repository defined in DMV architecture

% The audience should know these, so no need to highlight them.
\glsunset{RNG}
\glsunset{ABI}
